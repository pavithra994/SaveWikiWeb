"""
Django settings for SaveWiki project.
...
SECRET_KEY = 't+!lt3s5gu8(+fkwiebd=4m019sqxpnjr2%don(*zvylm+n4d^'
...
WSGI_APPLICATION = 'SaveWiki.wsgi.application'
